...
function optionChanged(job_city) {
    console.log("optionChanged")
    console.log(job_city)

    d3.json("http://127.0.0.1:5000/api/job_category/" + job_city).then(function (data) {
        // console.log(data)
    ...
    d3.json("http://127.0.0.1:5000/api/job_info/" + job_city).then(function (data) {
        // console.log(data)
        ...
        header.text('Job Apply Link');
        header = tbl_header.append("th");
        header.text('Job City');
        header = tbl_header.append("th");
        header.text('Job Description');
        header = tbl_header.append("th");
        header.text('Job Publisher');
        header = tbl_header.append("th");
        header.text('Job State');
        header = tbl_header.append("th");
        header.text('Job Title');
        header = tbl_header.append("th");
        header.text('Job Employment Type');
